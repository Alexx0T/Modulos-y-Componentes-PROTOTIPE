# Calendario de Lanzamientos (ComponentCalendar)

Módulo interactivo mensual para el mapeo visual y registro histórico de nuevos componentes del ecosistema SaaS.

---

## 1. Propósito y Casos de Uso
* **Trazabilidad de Lanzamientos:** Centraliza en una vista de calendario interactiva todos los componentes agregados, permitiendo a desarrolladores e IAs inspeccionar versiones y propósitos.
* **Control Detallado:** Panel lateral sincronizado con Framer Motion que despliega las categorías y descripciones de los componentes al presionar una fecha activa.
* **Casos de Uso:**
  * Widget de auditoría técnica en tableros de control.
  * Timeline de lanzamientos en portales de desarrolladores.

---

## 2. Especificación Visual (Tailwind CSS HSL)
* **Cuadrícula Responsive:** Diseño de días del mes en cuadrícula adaptable (`grid-cols-7`) con relieve de estados seleccionados y activos mediante el color de marca del tenant.
...
|------|------|---------|-------------|
| `components` | `array` | - | Arreglo de objetos de componentes registrados con propiedades `{ id, name, date, description, category }`. |

---

## 4. Código React Fuente Completo (`ComponentCalendar.jsx`)
```jsx
...
## 5. Origen
* **Extraído de:** `src/components/ComponentCalendar.jsx`
